...
const SalesOverview: React.FC<SalesOverviewProps> = ({ onClose }) => {
  const initialSalesData: SalesData[] = [
    {
      id: '1',
      productName: 'All-Season Tire A',
      manufacturer: 'Tire Co.',
      category: 'Tires',
    ...
    {
      id: '2',
      productName: 'Winter Tire B',
      manufacturer: 'Winter Wheels',
      category: 'Tires',
    ...
    {
      id: '3',
      productName: 'Performance Tire C',
      manufacturer: 'Speedy Tires',
      category: 'Tires',
      dateOfSale: '2024-10-03',
      quantitySold: 10,
      totalSaleValue: '$1000',
    },
    {
      id: '4',
      productName: 'Oil Synthetic X',
      manufacturer: 'Lubricants Inc.',
      category: 'Oil',
    ...
    {
      id: '5',
      productName: 'All-Season Tire D',
      manufacturer: 'Tire Co.',
      category: 'Tires',
      dateOfSale: '2024-10-05',
      quantitySold: 15,
      totalSaleValue: '$1500',
    },
    {
      id: '6',
      productName: 'Oil Mineral Y',
      manufacturer: 'Engine Essentials',
      category: 'Oil',
      dateOfSale: '2024-10-06',
      quantitySold: 8,
      totalSaleValue: '$160',
    },
    {
      id: '7',
      productName: 'Sport Tire E',
      manufacturer: 'Racing Tires',
      category: 'Tires',
      dateOfSale: '2024-10-07',
      quantitySold: 4,
      totalSaleValue: '$800',
    },
    {
      id: '8',
      productName: 'Oil Synthetic Z',
      manufacturer: 'Lubricants Inc.',
      category: 'Oil',
      dateOfSale: '2024-10-08',
      quantitySold: 12,
      totalSaleValue: '$240',
    },
    {
      id: '9',
      productName: 'Truck Tire F',
      manufacturer: 'Heavy Duty Tires',
      category: 'Tires',
      dateOfSale: '2024-10-09',
      quantitySold: 2,
      totalSaleValue: '$300',
    },
    {
      id: '10',
      productName: 'All-Season Tire G',
      manufacturer: 'Tire Co.',
      category: 'Tires',
      dateOfSale: '2024-10-10',
      quantitySold: 6,
      totalSaleValue: '$600',
    },
  ];
  ...
  const [filteredData, setFilteredData] =
    useState<SalesData[]>(initialSalesData);
    ...
    const filtered = initialSalesData.filter((item) => {
      ...
      const matchesDateRange =
        dateRange[0] && dateRange[1]
          ? new Date(item.dateOfSale) >= dateRange[0]?.toDate() &&
            new Date(item.dateOfSale) <= dateRange[1]?.toDate()
          : true;
  ...
  async function handleEmail(
    SalesData: any,
    emailData: { recipient: string; subject: string; message: string },
  ) {
    // Generate PDF
    const doc = new jsPDF();
  ...
  return (
    <div style={{ padding: '20px' }}>
          ...
          },
          {
            ...
            render: (text, record) => (
              <Space size="middle">
                ...
                <Button onClick={handleEmailClick} style={{ marginLeft: 8 }}>
                  Email
                </Button>
              </Space>
            ),
      ...
      <Modal
        ...
        footer={null} // Set to null if you want to customize footer or leave it out
      >
        <EmailForm salesData={initialSalesData as any} />
      </Modal>
    </div>
  );
};
