...
const InputPhone = React.lazy(() => import('./shared/phoneInput'));
...
function ProvidersFormX({ action }: IClientFormType) {
        ...
        /> */}
          ...
          <PhoneInput
            ...
            onChange={(value) =>
              setPhone((prevState) => ({
                ...prevState,
                values: { ...prevState.values, Nb1: value },
              }))
            }
          />
            ...
            <div className="inputs">
              <PhoneInput
                ...
                onChange={(value) =>
                  setPhone((prevState) => ({
                    ...prevState,
                    values: { ...prevState.values, Nb2: value },
                  }))
                }
              />
              ...
              <PhoneInput
                ...
                onChange={(value) =>
                  setPhone((prevState) => ({
                    ...prevState,
                    values: { ...prevState.values, Nb3: value },
                  }))
                }
              />
              ...
              <PhoneInput
                ...
                onChange={(value) =>
                  setPhone((prevState) => ({
                    ...prevState,
                    values: { ...prevState.values, Nb4: value },
                  }))
                }
              />
              {/* <InputPhone
...
const ProvidersForm = React.memo(ProvidersFormX);
