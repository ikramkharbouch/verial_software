...
import DropdownRender from "./DropDown.js";


const ClientsForm = () => {
  return (
    <div>
      <h1 className="text-xl font-semibold mx-5">Client's Form: </h1>

      <form className="flex flex-wrap mx-5 gap-5 mt-3 w-full">
        {/* File Number */}
        <div className="mb-5">
          <label
            for="email"
          ...
          <input
            type="number"
            id="number"
            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 font-semibold text-center"
            value="1009"
            required
          />
        </div>
        ...
        <div class="-mb-2 flex items-center w-3/12">
          <input
            type="insurance"
            id="insurance"
            class="pr-12 w-full text-left bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5"
            placeholder="Your insurance details here..."
            required
          />
          <SearchOutlined className="-ml-9" />
        </div>
        ...
        <div className="mb-5">
          ...
          <input
            type="text"
            id="text"
            class=" text-red-700 bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 font-semibold text-center"
            value="#739202"
            required
          />
        </div>
        ...
        <div class="hs-dropdown relative w-2/6 block">
          <button
            id="hs-dropdown-unstyled"
            type="button"
            class="hs-dropdown-toggle inline-flex justify-center items-center gap-x-2"
            aria-expanded="false"
            aria-label="Menu"
          >
            Client's Types
        ...
        <div class="mb-5 w-1/5">
          ...
          <input
            type="text"
            id="FirstName"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 font-semibold"
            placeholder="Lhaj"
            required
          />
        </div>
        ...
        <div class="mb-5 w-1/5">
          <label for="ICEO" class="block mb-2 text-sm font-medium">
            ICEO
          </label>
          <input
            type="text"
        ...
        <div class="mb-5 w-1/5">
          <label for="TaxName" class="block mb-2 text-sm font-medium">
            ICEO
          </label>
          <input
            type="text"
        ...
        {/* <div class="flex items-top">
          <button
            ...
            class="flex-shrink-0 z-10 flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-300 rounded-s-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100"
            type="button"
          >
            <svg
              fill="none"
      ...
      <div>
            ...
            <h2 className="text-red-700 font-2xl m-5 font-medium">Phone Details:</h2>
            <form>
